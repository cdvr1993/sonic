...
func (c config) MarshalToString(v interface{}) (string, error) {
	panic(_errDisallowed)
}
...
func (c config) MarshalIndent(v interface{}, prefix, indent string) ([]byte, error) {
	panic(_errDisallowed)
}

func (c config) UnmarshalFromString(str string, v interface{}) error {
	panic(_errDisallowed)
}
...
func (c config) NewEncoder(writer io.Writer) Encoder {
	panic(_errDisallowed)
}

func (c config) NewDecoder(reader io.Reader) Decoder {
	panic(_errDisallowed)
}

func (c config) Valid(data []byte) bool {
	panic(_errDisallowed)
}

var ConfigStd API = &config{}

var _errDisallowed = errors.New("the use of this library is not allowed")
